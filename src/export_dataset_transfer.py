...
from config import transfer_train_directory, transfer_test_directory, train_size, transfer_categories
import os
import shutil
...
if __name__ == "__main__":
    ...
    copy_dataset(train_source_directory, train_target_directory, transfer_categories, train_size)
